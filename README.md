...
一个在安卓手机本地运行、以专辑为中心的私人音乐感受记录 APK。它只保存你手动输入或确认过的信息，不自动编造歌曲、专辑、歌手或感受。v2.9 将年度榜单升级为青绿鎏金拼贴海报：每页最多五张，冠军大封面，名次分组从后向前展示，字体随安装包离线提供。已保存的专辑封面可直接复用；保留黑胶首页、十分制、独立草稿和无封面备份。
...
当前安卓版本为 `2.9 (26)`（npm 包版本 `2.9.0`），沿用 v2.5 至 v2.8.0 的长期发布签名，可覆盖这些正式版本，无需卸载。更早旧签名版本和 debug 版本请先备份再迁移。

- [下载 v2.9 APK](https://github.com/Yvesyzy/xiaodongge/releases/download/v2.9/codex_xiaodongge-v2.9.apk)
- [下载 SHA256 校验文件](https://github.com/Yvesyzy/xiaodongge/releases/download/v2.9/codex_xiaodongge-v2.9.sha256.txt)

发布页：[小懂哥 v2.9](https://github.com/Yvesyzy/xiaodongge/releases/tag/v2.9)。

签名证书 SHA-256：`6386734ef9b4a3fe106d690a8d31ae952697c2ea652ea1ee82f3f7ab488f1022`。

APK SHA-256：`f8923da74bb59af85bf5c86fee582e6890f4327f8091ce28c5154247fa0968c0`；大小 79,453,121 字节。

本版通过根项目及移动端类型检查、32项基础测试、1–15张榜单共30页场景、年度标签和分享回归、Android正式签名构建与包内资源逐文件核对。当前没有连接真机，安装与系统分享需在手机上验收。
...
JSON 备份格式为 v5，包含追加听感、今日重逢状态、月度作品、结构化年度结果、天气设置/缓存、代表原句、语义校正和年度专辑榜单，并继续接受 v1 至 v4 备份。Android 系统云备份已关闭，避免私人乐评被系统自动复制；卸载前应从备份页保存 JSON。
