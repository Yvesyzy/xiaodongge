...
export const GENRE_TREE = [
  {
    label: "流行",
    children: [
      { label: "Dance Pop", children: [{ label: "Teen Pop" }, { label: "Euro Pop" }, { label: "Bubblegum Pop" }, { label: "Eurodance Pop" }] },
      { label: "Indie Pop", children: [{ label: "Twee Pop" }, { label: "Jangle Pop" }, { label: "Dream Pop" }, { label: "Chamber Pop" }] },
      { label: "Art Pop", children: [{ label: "Baroque Pop" }, { label: "Avant-Pop" }] },
      { label: "Synth Pop", children: [{ label: "Electropop" }, { label: "Sophisti-Pop" }, { label: "Italo Dance" }] },
      { label: "Hyperpop", children: [{ label: "Glitchcore" }, { label: "Digicore" }, { label: "Scenecore" }, { label: "HexD" }] },
      { label: "Bedroom Pop" },
      { label: "Ambient Pop" },
      { label: "Alt-Pop" },
      { label: "City Pop" },
      { label: "K-Pop", children: [{ label: "K-Hip-Hop" }, { label: "K-R&B" }, { label: "K-Rock" }] },
      { label: "J-Pop", children: [{ label: "Shibuya-kei" }, { label: "Anison" }, { label: "J-Rock" }] },
      { label: "C-Pop", children: [{ label: "Mandopop" }, { label: "Cantopop" }, { label: "Taiwanese Pop" }] },
      { label: "Europop" },
      { label: "Latin Pop" },
    ],
  },
  {
    ...
    children: [
      ...
      { label: "Alternative Rock", children: [{ label: "Grunge" }, { label: "Post-Grunge" }, { label: "Britpop" }, { label: "Shoegaze" }, { label: "Post-Rock" }, { label: "Noise Rock" }, { label: "College Rock" }, { label: "Slacker Rock" }, { label: "Neo-Psychedelia" }] },
      ...
      { label: "Psychedelic Rock", children: [{ label: "Acid Rock" }, { label: "Space Rock" }, { label: "Raga Rock" }, { label: "Garage Psych" }] },
      ...
      { label: "Regional Rock", children: [{ label: "Latin Rock" }, { label: "Rock en Espanol" }, { label: "J-Rock" }, { label: "Anatolian Rock" }, { label: "Zamrock" }, { label: "Rock Andaluz" }, { label: "Samba-Rock" }] },
  ...
  },
  {
    label: "电子",
    children: [
      { label: "House", children: [{ label: "Deep House" }, { label: "Tech House" }, { label: "Acid House" }, { label: "Progressive House" }, { label: "Electro House" }, { label: "Future House" }, { label: "Bass House" }, { label: "Afro House" }, { label: "Tropical House" }, { label: "Chicago House" }, { label: "French House" }, { label: "Garage House" }, { label: "Microhouse" }, { label: "Organic House" }, { label: "Vocal House" }, { label: "Big Room House" }, { label: "Speed House" }] },
      { label: "Techno", children: [{ label: "Detroit Techno" }, { label: "Minimal Techno" }, { label: "Acid Techno" }, { label: "Industrial Techno" }, { label: "Dub Techno" }, { label: "Deep Techno" }, { label: "Hard Techno" }, { label: "Melodic Techno" }, { label: "Bleep Techno" }, { label: "Peak Time Techno" }, { label: "Hardgroove Techno" }, { label: "Hypertechno" }, { label: "Schranz" }] },
      { label: "Trance", children: [{ label: "Progressive Trance" }, { label: "Psytrance" }, { label: "Uplifting Trance" }, { label: "Goa Trance" }, { label: "Hard Trance" }, { label: "Acid Trance" }, { label: "Vocal Trance" }, { label: "Tech Trance" }, { label: "Dream Trance" }, { label: "Balearic Trance" }, { label: "Dark Psytrance" }, { label: "Forest Psytrance" }, { label: "Trancecore" }] },
      ...
      { label: "Dubstep", children: [{ label: "Brostep" }, { label: "Riddim" }, { label: "Post-Dubstep" }, { label: "Melodic Dubstep" }, { label: "Tearout" }, { label: "Trancestep" }, { label: "Chillstep" }, { label: "Future Garage" }] },
      ...
      { label: "UK Garage / Bass", children: [{ label: "UK Garage" }, { label: "2-Step" }, { label: "Speed Garage" }, { label: "Dark Garage" }, { label: "Bassline" }, { label: "Footwork" }, { label: "Juke" }, { label: "Footwork Jungle" }] },
      ...
      { label: "Synth / Vapor", children: [{ label: "Synthwave" }, { label: "Vaporwave" }, { label: "Witch House" }, { label: "Future Funk" }, { label: "Chillwave" }] },
      ...
      { label: "Hardcore / Hardstyle", children: [{ label: "Gabber" }, { label: "Happy Hardcore" }, { label: "Breakcore" }, { label: "Hardstyle" }, { label: "Hardcore Techno" }, { label: "Industrial Hardcore" }, { label: "Freeform Hardcore" }, { label: "Uptempo Hardcore" }] },
      { label: "Amapiano", children: [{ label: "Private School Amapiano" }, { label: "Soulful Amapiano" }, { label: "Amapiano Grooves" }] },
      { label: "Phonk", children: [{ label: "Drift Phonk" }, { label: "Brazilian Phonk" }, { label: "House Phonk" }, { label: "Gym Phonk" }, { label: "Memphis Phonk" }] },
      { label: "Gqom" },
    ],
  },
  {
    label: "Hip-Hop / Rap",
    children: [
      { label: "Boom Bap", children: [{ label: "East Coast Hip-Hop" }, { label: "Hardcore Hip-Hop" }, { label: "Jazz Rap" }, { label: "Chipmunk Soul" }] },
      { label: "Trap Rap", children: [{ label: "Drill" }, { label: "UK Drill" }, { label: "Brooklyn Drill" }, { label: "Rage" }, { label: "Plugg" }, { label: "Cloud Rap" }, { label: "Tread" }, { label: "Dark Trap" }, { label: "Pluggnb" }] },
      { label: "Alternative Hip-Hop", children: [{ label: "Abstract Hip-Hop" }, { label: "Experimental Hip-Hop" }, { label: "Industrial Hip-Hop" }, { label: "Lo-Fi Hip-Hop" }, { label: "Trip Hop" }, { label: "Instrumental Hip-Hop" }] },
      { label: "Conscious Hip-Hop", children: [{ label: "Political Rap" }, { label: "Afrocentric Rap" }] },
      { label: "Gangsta Rap", children: [{ label: "G-Funk" }, { label: "Mafioso Rap" }, { label: "West Coast Hip-Hop" }] },
      { label: "Southern Hip-Hop", children: [{ label: "Crunk" }, { label: "Memphis Rap" }, { label: "Houston Rap" }, { label: "Bounce" }, { label: "Chopped and Screwed" }, { label: "Miami Bass" }] },
      { label: "Grime", children: [{ label: "UK Garage" }, { label: "Road Rap" }, { label: "Afroswing" }] },
      { label: "Latin Trap", children: [{ label: "Reggaeton" }, { label: "Dembow" }, { label: "Latin Hip-Hop" }] },
      { label: "Jersey Club", children: [{ label: "Philly Club" }, { label: "Baltimore Club" }] },
      { label: "Hyperpop / Digicore", children: [{ label: "Glitchcore" }, { label: "Hyperpop Rap" }, { label: "Digicore" }] },
      { label: "Emo Rap", children: [{ label: "SoundCloud Rap" }, { label: "Sad Rap" }, { label: "Melodic Rap" }] },
      { label: "Mumble Rap" },
      { label: "Afrobeats Rap" },
      { label: "K-Hip-Hop" },
      { label: "J-Hip-Hop" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Contemporary R&B", children: [{ label: "Alternative R&B" }, { label: "New Jack Swing" }, { label: "Quiet Storm" }, { label: "Trap Soul" }, { label: "Hip Hop Soul" }, { label: "Urban Contemporary" }, { label: "Pop R&B" }, { label: "Indie R&B" }, { label: "Bedroom R&B" }, { label: "Dark R&B" }, { label: "Chill R&B" }, { label: "Experimental R&B" }, { label: "Psychedelic R&B" }] },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Country", children: [{ label: "Alternative Country" }, { label: "Country Pop" }, { label: "Outlaw Country" }, { label: "Honky Tonk" }, { label: "Bro-Country" }, { label: "Americana" }, { label: "Country Rock" }, { label: "Bakersfield Sound" }, { label: "Nashville Sound" }] },
      ...
      { label: "African / Afro-Diaspora", children: [{ label: "Afrobeat" }, { label: "Afrobeats" }, { label: "Afro-Fusion" }, { label: "Afro-Pop" }, { label: "Highlife" }, { label: "Soukous" }, { label: "Juju" }, { label: "Mbalax" }, { label: "Gnawa" }, { label: "Bongo Flava" }, { label: "Gengetone" }, { label: "Raï" }] },
      { label: "European / Mediterranean World", children: [{ label: "Celtic" }, { label: "Klezmer" }, { label: "Fado" }, { label: "Fado de Coimbra" }, { label: "Flamenco" }, { label: "Nuevo Flamenco" }, { label: "Sevdah" }] },
      { label: "Americas / Caribbean", children: [{ label: "Cajun" }, { label: "Zydeco" }, { label: "Nouveau Zydeco" }, { label: "Calypso" }, { label: "Soca" }] },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Roots Reggae" },
      { label: "Dub" },
      { label: "Dancehall", children: [{ label: "Ragga" }, { label: "Reggae Fusion" }] },
      { label: "Lovers Rock" },
    ],
  },
  {
    label: "拉丁",
    children: [
      { label: "Reggaeton", children: [{ label: "Latin Trap" }, { label: "Dembow" }, { label: "Bachateo" }, { label: "Cubaton" }] },
      { label: "Salsa", children: [{ label: "Salsa Dura" }, { label: "Salsa Romantica" }, { label: "Salsa Cubana" }] },
      { label: "Bachata", children: [{ label: "Traditional Bachata" }, { label: "Modern Bachata" }] },
      { label: "Merengue" },
      { label: "Cumbia", children: [{ label: "Cumbia Colombiana" }, { label: "Cumbia Sonidera" }, { label: "Cumbia Peruana" }, { label: "Cumbia Villera" }, { label: "Cumbia 420" }, { label: "Cumbia Amazonica" }] },
      { label: "Corridos", children: [{ label: "Corridos Tumbados" }, { label: "Corridos Bélicos" }, { label: "Narcocorridos" }, { label: "Corridos Tradicionales" }] },
      { label: "Mariachi", children: [{ label: "Mariachi Tradicional" }, { label: "Mariachi Moderno" }] },
      { label: "Norteño", children: [{ label: "Conjunto Norteno" }, { label: "Tejano" }, { label: "Sierreño" }] },
      { label: "Banda", children: [{ label: "Banda Sinaloense" }] },
      { label: "Latin Pop" },
      { label: "Bossa Nova" },
      { label: "Samba", children: [{ label: "Samba de Roda" }, { label: "Samba Reggae" }, { label: "Pagode" }] },
      { label: "Tango", children: [{ label: "Tango Argentino" }, { label: "Tango Electronico" }, { label: "Neo Tango" }] },
      { label: "Bolero" },
      { label: "Mambo" },
      { label: "Cha-Cha" },
      { label: "Rumba" },
      { label: "Latin Alternative", children: [{ label: "Rock en Espanol" }, { label: "Latin Alternative Rock" }, { label: "Latin Urban" }] },
      { label: "Tropical", children: [{ label: "Tropical Latin" }, { label: "Tropical Rock" }] },
    ],
  },
  {
    label: "金属",
  ...
  },
  {
    label: "实验 / 工业 / 噪音",
    children: [
      { label: "Avant-Garde", children: [{ label: "Free Improvisation" }, { label: "Modern Composition" }, { label: "Sound Art" }, { label: "Microtonal" }, { label: "Tape Music" }] },
      { label: "Noise", children: [{ label: "Harsh Noise" }, { label: "Noise Wall" }, { label: "Power Electronics" }, { label: "Japanoise" }, { label: "Harsh Noise Wall" }] },
      { label: "Industrial", children: [{ label: "EBM" }, { label: "Aggrotech" }, { label: "Dark Electro" }, { label: "Power Noise" }] },
  ...
  },
  {
    label: "影视 / 舞台",
    children: [
      { label: "Film Score", children: [{ label: "Orchestral Soundtrack" }, { label: "Cinematic Ambient" }] },
      { label: "Soundtrack" },
      { label: "Musical" },
      { label: "Video Game Music", children: [{ label: "Chiptune" }, { label: "8-bit" }, { label: "Orchestral Game Soundtrack" }, { label: "VGM" }] },
      { label: "Anime", children: [{ label: "Anime Score" }, { label: "Anime Song" }, { label: "J-Pop Soundtrack" }] },
    ],
  },
  {
    label: "新世纪 / 轻音乐",
    children: [
      { label: "New Age", children: [{ label: "Contemporary Instrumental" }, { label: "Ethnic Fusion" }, { label: "Neo-Classical" }, { label: "Healing" }, { label: "Meditation" }] },
      { label: "Easy Listening", children: [{ label: "Lounge" }, { label: "Beautiful Music" }, { label: "Exotica" }, { label: "Space Age Pop" }] },
      { label: "Nature / Field Recordings" },
    ],
  },
